--https://www.pythian.com/blog/t-sql-script-return-replication-info-plus-undistributed-commands
--https://blog.rajanand.org/sql-server-replication-queries#heading-undistributed-commands-for-each-table
...
,sub1.publisher_db
,sub1.publication
,CASE when sub1.anonymous_subid is not null then upper(sub1.subscriber_name) ELSE UPPER ('NODE2') END 'Subscriber' -- pass subscriber name
,sub1.subscriber_db
,Sub1.job_id,sub1.id
,subscription_type
,sub1.name
