/*
--drop table tbl_memory_usgae_2012_Below_New

select * from tbl_memory_usgae_2012_Below_New

use dbadata
go
drop table tbl_memory_usgae_2012_Below_New
go
CREATE TABLE [dbo].[tbl_memory_usgae_2012_Below_New](
...
--DROP PROC [[[Usp_Memory_alert_2012_Below_New]]]
alter proc [dbo].[Usp_Memory_alert_2012_Below_New]
/*
...
TRUNCATE TABLE tbl_memory_usgae_2012_Below_New
...
WHERE Version in ('SQL2008','SQL2008R2')
and Description not in ('DBA_MILEPMIP03')
...
set @sql2=
'EXEC(''SELECT * from OPENQUERY(['+@server_name+'],
''''SELECT '''''''''+@Desc+''''''''',[physical_memory_in_bytes]/1024/1024 AS [PhysMemmB],
...
'''')'')
'
insert into dbadata.dbo.tbl_memory_usgae_2012_Below_New
exec(@sql2)
...
update t set ple= cntr_value
from tbl_memory_usgae_2012_Below_New t join #tbl a 
on t.cntr_type=a.cntr_type where t.servername =a.servername 
--print @sql1
END
...
IF EXISTS (
SELECT * FROM dbadata.dbo.tbl_memory_usgae_2012_Below_New
where PLE <=300
) 
begin
...
FROM dbadata.dbo.tbl_memory_usgae_2012_Below_New 
where PLE <=300
...
@SUBJECT = 'DBA: RAM Usage SQL 2008 and 2008R2',
@BODY = @BODY1,
...
*/
insert into DBAdata_Archive.dbo.tbl_memory_usgae_2012_Below_New
select *,getdate() from tbl_memory_usgae_2012_Below_New
